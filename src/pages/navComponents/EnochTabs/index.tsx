      ...
      <View className='EnochTabs'>
        ...
        <AtTabs
          ...
          <AtTabsPane tabDirection='vertical' current={this.state.vCurrent} index={0}>
            <View style='font-size:18px;text-align:center;height:150px;'>标签页一的内容</View>
          </AtTabsPane>
          <AtTabsPane tabDirection='vertical' current={this.state.vCurrent} index={1}>
            <View style='font-size:18px;text-align:center;height:150px;'>标签页二的内容</View>
          </AtTabsPane>
          <AtTabsPane tabDirection='vertical' current={this.state.vCurrent} index={2}>
            <View style='font-size:18px;text-align:center;height:150px;'>标签页三的内容</View>
          </AtTabsPane>
          <AtTabsPane tabDirection='vertical' current={this.state.vCurrent} index={3}>
            <View style='font-size:18px;text-align:center;height:150px;'>标签页四的内容</View>
          </AtTabsPane>
          <AtTabsPane tabDirection='vertical' current={this.state.vCurrent} index={4}>
            <View style='font-size:18px;text-align:center;height:150px;'>标签页五的内容</View>
          </AtTabsPane>
          <AtTabsPane tabDirection='vertical' current={this.state.vCurrent} index={5}>
            <View style='font-size:18px;text-align:center;height:150px;'>标签页六的内容</View>
          </AtTabsPane>
        </AtTabs>
      </View>
    )
